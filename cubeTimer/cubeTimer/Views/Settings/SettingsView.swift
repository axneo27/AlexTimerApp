...
struct SettingsView: View {
    ...
    @State var inspectionEnabled: Bool = false
    @StateObject var dataUpdater = mainDataUpdater()
...
//            Text("\(inspectionEnabled ? 1 : 0)")
//            Text("\(dataUpdater.isInspectionEnabled ? 1 : 0)")
            settingsSector(
                Toggle(isOn: $inspectionEnabled) {
                    Text("Enable 15-second inspetion")
...
//        .onChange(of: inspectionEnabled) { _ in
//            dataUpdater.isInspectionEnabled.toggle()
//        }
//        .onAppear {
//            inspectionEnabled = dataUpdater.isInspectionEnabled
//        }
    }
