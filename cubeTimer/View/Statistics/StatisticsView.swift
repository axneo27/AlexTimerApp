...
//                        .padding(8)
    ...
    private func deleteSolve(at offsets: IndexSet) { // some shit here ...graph puzzle?????
        for index in offsets {
            ...
            dataManager.deleteSolve(at: solveIndex, items: visibleSolves) { _ in // some shit hereeasdjklhfjlads
